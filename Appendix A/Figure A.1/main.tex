...
\draw[ultra thick, red_set, -Stealth] plot [smooth, tension=1] coordinates {(green_bottom) (red_top_opposite) (up_left_bottom)};

\draw[ultra thick, purple_set, -Stealth] plot [smooth, tension=1] coordinates {(green_bottom) (coolio) (up_right_bottom)};

\draw[ultra thick, red_set, -Stealth] plot [smooth, tension=1] coordinates {(up_right_bottom) (purple_top_opposite) (center)};

\draw[ultra thick, purple_set, -Stealth] plot [smooth, tension=1] coordinates {(up_left_bottom) (bobob) (center)};

\draw[ultra thick, green_set, -Stealth] plot [smooth, tension=1] coordinates {(center) (green_top) (green_bottom)};

\draw[ultra thick, purple_set, -Stealth] plot [smooth, tension=1] coordinates {(center) (purple_top) (purple_bottom)};

\draw[ultra thick, red_set, -Stealth] plot [smooth, tension=1] coordinates {(center) (red_top) (red_bottom)};

\draw[ultra thick, green_set, -Stealth] plot [smooth, tension=1] coordinates {(purple_bottom) (up_right_top) (up_right_bottom)};
